...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    useEffect(() => {
        if (doctors.length > 0 && speciality) {
            const doctorsData = doctors.filter((doct) => doct.speciality === speciality && doct._id != docId)
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            <p className='sm:w-1/3 text-center text-sm'>Browse through a list of our trusted doctors.</p>
