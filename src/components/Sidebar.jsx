        ...
        <div className='min-h-screen bg-white border-r w-64'>
            {
                aToken && <ul className='text-[#515151] mt-5'>
                    ...
                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/wards'}>
                        <img src={assets.people_icon} alt="" />
                        <p className='hidden md:block'>Wards</p>
                    </NavLink>

                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/rooms'}>
                        <img src={assets.people_icon} alt="" />
                        <p className='hidden md:block'>Rooms</p>
                    </NavLink>

                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/billing'}>
            ...
            }
            {
                dToken && <ul className='text-[#515151] mt-5'>
                    ...
                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/doctor-medical-records'}>
                        <img src={assets.people_icon} alt="" />
